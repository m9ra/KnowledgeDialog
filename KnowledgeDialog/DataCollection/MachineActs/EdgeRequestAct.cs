...
{
    public class EdgeRequestAct : MachineActionBase
    {
        ...
        public EdgeRequestAct(string label1, string requestedRelation, string relationFormat, string label2)
        {
            _label1 = label1;
        ...
        protected override string initializeMessage()
        {
            ...
            return string.Format("How to say '{0}' in a better way?", expression);
        }

        /// <inheritdoc/>
        protected override ActRepresentation initializeDialogActRepresentation()
        {
            var representation = new ActRepresentation("EdgeRequest");
