...
namespace PerceptiveDialogBasedAgent.V4.EventBeam.TODO
{
    ...
    class ExecutionBeamGenerator : BeamGenerator
    {
        ...
        protected override bool IsSatisfiedBy(SubstitutionRequestEvent request, ConceptInstance instance)
        {
            if (request.Target.Concept == Concept2.ActionToExecute)
                return _conceptCallbacks.ContainsKey(instance.Concept);

            return base.IsSatisfiedBy(request, instance);
        }
    }
}
