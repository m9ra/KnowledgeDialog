...
namespace WebBackend.Task
{
    class CollectionTaskInstance : TaskInstance
    {
        ...
        internal CollectionTaskInstance(string taskFormat, IEnumerable<NodeReference> substitutions, IEnumerable<NodeReference> requiredEntityAliases, string key, int validationCode) :
            base(taskFormat, substitutions, new NodeReference[0], key, validationCode)
        {
